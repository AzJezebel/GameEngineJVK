...
StaticMesh::StaticMesh(size_t indexActorTransform, size_t indexMesh, std::string meshPath, std::string texturePath) : myIndex(indexMesh),
transformID(indexActorTransform)
{
	LoadModel(meshPath);
...
void StaticMesh::LoadModel(std::string_view path)
{
...
void StaticMesh::LoadTexture(std::string_view path)
{
